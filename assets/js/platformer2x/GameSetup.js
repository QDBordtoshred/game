...
const GameSetup = {
    ...
    */
    ...
    initLevels: function(path) {  // ensure valid {{site.baseurl}} for path
        ...
        { name: 'goombaSpecial', id: 'goomba', class: Goomba, data: this.assets.enemies.goomba, xPercentage:  0.95, yPercentage: 1, minPosition: 0.5 }, //this special name is used for random event 2 to make sure that only one of the Goombas ends the random event
